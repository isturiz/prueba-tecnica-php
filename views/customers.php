<div class="relative overflow-x-auto hidden" id="customers-section">
  ...
  <div>
    ...
    <div class="flex flex-row w-full items-center justify-between pb-4">
      ...
      <?php include_once 'modals/forms/customer.php' ?>
    ...
    <p class="search-result-message pt-4 pl-4 text-sm text-gray-800 dark:text-gray-200 hidden font-medium" data-result-message="customerTable"></p>
