<div class="relative overflow-x-auto hidden" id="category-products-section">
  ...
  <div>
    ...
    <div class="flex flex-row w-full items-center justify-between pb-4">
      ...
      <div class="flex py-3 flex-row items-center justify-between space-y-0 space-x-4">
        <div>
          <label for="category-products-search" class="sr-only">Buscar</label>
  ...
  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" data-searchable id="categoryProductTable">
